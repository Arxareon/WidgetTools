...
--English
---@return widgetToolsStrings_enUS
...
--Portuguese (Brazil)
---@return widgetToolsStrings_ptBR
function localizations.ptBR() return {
	about = {
...
--German
---@return widgetToolsStrings_deDE
function localizations.deDE() return {
	about = {
		version = "Version: #VERSION",
		date = "Datum: #DATE",
		author = "Autor: #AUTHOR",
...
--French
---@return widgetToolsStrings_frFR
function localizations.frFR() return {
	about = {
		version = "Version : #VERSION",
		date = "Date : #DATE",
...
--Spanish (Spain)
---@return widgetToolsStrings_esES
function localizations.esES() return {
	about = {
...
--Spanish (Mexico)
---@return widgetToolsStrings_esMX
function localizations.esMX() return {
	about = {
		version = "Versión: #VERSION",
		date = "Fecha: #DATE",
		author = "Autor: #AUTHOR",
...
--Italian
---@return widgetToolsStrings_itIT
function localizations.itIT() return {
	about = {
...
--Korean
---@return widgetToolsStrings_koKR
function localizations.koKR() return {
	about = {
		version = "버전: #VERSION",
		date = "날짜: #DATE",
		author = "작성자: #AUTHOR",
...
---@return widgetToolsStrings_zhTW
function localizations.zhTW() return {
	about = {
		version = "版本：#VERSION",
		date = "日期：#DATE",
		author = "作者：#AUTHOR",
...
---@return widgetToolsStrings_zhCN
function localizations.zhCN() return {
	about = {
		version = "版本：#VERSION",
		date = "日期：#DATE",
		author = "作者：#AUTHOR",
...
--Russian
---@return widgetToolsStrings_ruRU
function localizations.ruRU() return {
	about = {
