...
---@field accountData table Reference to the account-bound SavedVariables addon database where profile data is to be stored<ul><li>***Note:*** A subtable will be created under the key: "profiles".</li></ul>
---@field characterData table Reference to the character-specific SavedVariablesPerCharacter addon database where selected profiles are to be specified<ul><li>***Note:*** A new string value will be added under the key: "activeProfile".</li></ul>
...
---@field onImport? fun(success: boolean, load: table) Function called after a settings backup string import has been performed by the user loading data for the currently active profile<hr><p>@*param* `success` boolean — Whether the imported string was successfully processed</p><p>@*param* `load` table — The table containing the imported backup data</p>
---@field onImportAllProfiles? fun(success: boolean, load: table) Function called after a settings backup string import has been performed by the user loading data for all profiles<ul><li>***Note:*** *t.onProfilesLoaded will also be called if the import was successful.</li></ul><hr><p>@*param* `success` boolean — Whether the imported string was successfully processed</p><p>@*param* `load` table — The table containing the imported backup data</p>
